...
path = r'C:\Users\downl\Desktop\codex-main\codex-rs\tui\src\bottom_pane\feedback\view.rs'
...
content = content.replace('BASE_BUG_ISSUE_URL', 'crate::bottom_pane::feedback::utils::BASE_ISSUE_URL')
...
content = content.replace('super::SelectionViewParams', 'crate::bottom_pane::SelectionViewParams')
content = content.replace('super::SelectionItem', 'crate::bottom_pane::SelectionItem')
content = content.replace('super::SelectionAction', 'crate::bottom_pane::SelectionAction')
