...
interface Plan {
  ...
  budget_time?: number;
  state: 'Drafting' | 'Pending' | 'Approved' | 'Rejected' | 'Executing' | 'Completed' | 'Failed' | 'drafting' | 'pending' | 'approved' | 'rejected' | 'executing' | 'completed';
  ...
  const handleCreatePlan = async () => {
    ...
    try {
      ...
      const createdPlan: Plan = {
        ...
        budget_tokens: result.budget_tokens || newPlan.budgetTokens,
        budget_time: result.budget_time || newPlan.budgetTime,
              ...
              <MuiCard>
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" gutterBottom>
                      Budget: {plan.budget_tokens?.toLocaleString() || 0} tokens, {plan.budget_time || 0} min
                    </Typography>
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 2 }}>
            ...
            <FormControl fullWidth>
              ...
              <Select
                value={newPlan.mode}
                onChange={(e) => setNewPlan({ ...newPlan, mode: e.target.value as 'single' | 'orchestrated' | 'competition' })}
